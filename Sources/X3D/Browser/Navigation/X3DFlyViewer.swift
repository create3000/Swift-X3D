   ...
   X3DViewer
{
   ...
   private final func addFly ()
   {
      ...
      browser! .addBrowserInterest (event: .Browser_Done, id: "fly", handler: { $0 .fly () }, requester: self)
      browser! .setNeedsDisplay ()
   }
   ...
   {
      browser! .removeBrowserInterest (event: .Browser_Done, id: "fly", requester: self)
   }
