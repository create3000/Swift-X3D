   ...
   X3DNodeInterface
{
   ...
   internal final override func initialize ()
   {
      ...
      $ambientIntensity     .addInterest ("set_ambientIntensity",     TwoSidedMaterial .set_ambientIntensity,     self)
      $diffuseColor         .addInterest ("set_diffuseColor",         TwoSidedMaterial .set_diffuseColor,         self)
      $specularColor        .addInterest ("set_specularColor",        TwoSidedMaterial .set_specularColor,        self)
      $emissiveColor        .addInterest ("set_emissiveColor",        TwoSidedMaterial .set_emissiveColor,        self)
      $shininess            .addInterest ("set_shininess",            TwoSidedMaterial .set_shininess,            self)
      $transparency         .addInterest ("set_transparency",         TwoSidedMaterial .set_transparency,         self)
      $backAmbientIntensity .addInterest ("set_backAmbientIntensity", TwoSidedMaterial .set_backAmbientIntensity, self)
      $backDiffuseColor     .addInterest ("set_backDiffuseColor",     TwoSidedMaterial .set_backDiffuseColor,     self)
      $backSpecularColor    .addInterest ("set_backSpecularColor",    TwoSidedMaterial .set_backSpecularColor,    self)
      $backEmissiveColor    .addInterest ("set_backEmissiveColor",    TwoSidedMaterial .set_backEmissiveColor,    self)
      $backShininess        .addInterest ("set_backShininess",        TwoSidedMaterial .set_backShininess,        self)
      $backTransparency     .addInterest ("set_backTransparency",     TwoSidedMaterial .set_backTransparency,     self)
