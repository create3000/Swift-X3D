...
public final class IndexedTriangleStripSet :
   X3DComposedGeometryNode,
   X3DNodeInterface
{
   // Common properties
   
   internal final override class var typeName       : String { "IndexedTriangleStripSet" }
   ...
   required internal init (with executionContext : X3DExecutionContext)
   {
      ...
      types .append (.IndexedTriangleStripSet)
   ...
   internal final override func create (with executionContext : X3DExecutionContext) -> IndexedTriangleStripSet
   {
      return IndexedTriangleStripSet (with: executionContext)
   }
