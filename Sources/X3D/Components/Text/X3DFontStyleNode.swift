   ...
   X3DNode
{
   ...
   internal final override func initialize ()
   {
      ...
      $family      .addInterest ("set_family",  { $0 .set_family () },  self)
      $style       .addInterest ("set_style",   { $0 .set_style () },   self)
      $horizontal  .addInterest ("set_justify", { $0 .set_justify () }, self)
      $leftToRight .addInterest ("set_justify", { $0 .set_justify () }, self)
      $topToBottom .addInterest ("set_justify", { $0 .set_justify () }, self)
      $justify     .addInterest ("set_justify", { $0 .set_justify () }, self)
