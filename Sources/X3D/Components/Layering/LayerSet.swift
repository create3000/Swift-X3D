   ...
   X3DNodeInterface
{
   ...
   internal final override func initialize ()
   {
      ...
      $activeLayer .addInterest ("set_activeLayer", { $0 .set_activeLayer () }, self)
      $order       .addInterest ("set_layers",      { $0 .set_layers () },      self)
      $layers      .addInterest ("set_layers",      { $0 .set_layers () },      self)
